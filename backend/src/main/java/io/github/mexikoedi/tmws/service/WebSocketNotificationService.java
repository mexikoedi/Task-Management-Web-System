...
public class WebSocketNotificationService {
   ...
   *
   * @param messagingTemplate Das SimpMessagingTemplate, das für die Kommunikation mit den
   *     WebSocket-Clients verwendet wird.
   */
  ...
  /**
   * Diese Methode sendet eine Nachricht an alle Clients, die mit dem angegebenen Benutzer verbunden
   * sind, um sie abzumelden.
   *
   * @param userId Die ID des Benutzers, der abgemeldet werden soll.
   * @param newTokenVersion Die neue Token-Version, die in der Nachricht enthalten sein soll, damit
   *     die Clients wissen, dass sie ihre Tokens ungültig machen müssen.
   */
  ...
  /**
   * Diese Methode sendet eine Nachricht an alle Clients, die mit dem angegebenen Board verbunden
   * sind, um sie zu benachrichtigen, dass das Board aktualisiert wurde. Zusätzlich werden alle
   * Mitglieder des Boards benachrichtigt, damit sie die Änderungen sehen können.
   *
   * @param board Das Board, das aktualisiert wurde und dessen Mitglieder benachrichtigt werden
   *     sollen.
   */
  ...
  /**
   * Diese Methode sendet eine Nachricht an alle Clients, die mit dem angegebenen Benutzer verbunden
   * sind, um sie zu benachrichtigen, dass sich etwas geändert hat.
   *
