...
public interface BoardColumnRepository extends JpaRepository<BoardColumn, Long> {
  /**
   * Diese Methode ermöglicht das Abrufen einer BoardColumn mit ihren zugehörigen Beziehungen
   * (Board, Spalten, Aufgaben und Assignees) anhand der ID.
   *
   * @param id Die ID der BoardColumn, die abgerufen werden soll.
   * @return Ein Optional, das die BoardColumn mit ihren Beziehungen enthält, wenn sie gefunden
   *     wird, oder leer ist, wenn sie nicht gefunden wird.
   */
  @Query(
      """
  ...
  /**
   * Diese Methode ermöglicht das Abrufen einer BoardColumn mit ihren zugehörigen Aufgaben und
   * Assignees anhand der ID.
   *
   * @param id Die ID der BoardColumn, die abgerufen werden soll.
   * @return Ein Optional, das die BoardColumn mit ihren Aufgaben und Assignees enthält, wenn sie
