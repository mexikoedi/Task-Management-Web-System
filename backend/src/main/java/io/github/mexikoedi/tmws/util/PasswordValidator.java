...
public class PasswordValidator {
  /**
   * Validiert ein Passwort nach folgenden Kriterien: - Mindestens 8 Zeichen - Mindestens ein
   * Großbuchstabe - Mindestens ein Kleinbuchstabe - Mindestens eine Ziffer - Mindestens ein
   * Sonderzeichen (!@#$%^&*)
   */
