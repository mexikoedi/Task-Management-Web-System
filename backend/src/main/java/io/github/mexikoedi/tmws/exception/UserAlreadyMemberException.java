/**
 * Diese Klasse definiert eine benutzerdefinierte Ausnahme, die ausgelöst wird, wenn ein Benutzer bereits
 * Mitglied eines Teams ist und versucht, erneut eingeladen zu werden.
 */
