...
public class BoardController {
   ...
   *
   * @param boardService Die Service-Instanz, die die Geschäftslogik für Board- und Task-Verwaltung
   *     enthält.
   */
   ...
   *
   * @return Eine ResponseEntity mit einer Liste von BoardResponse-Objekten, die die Boards
   *     repräsentieren.
   */
  @GetMapping
  ...
  /**
   * GET /api/boards/{id} - Gibt die Details eines bestimmten Boards zurück, einschließlich seiner
   * Spalten und Aufgaben.
   *
   * @param id Die ID des Boards, das abgerufen werden soll.
   * @return Eine ResponseEntity mit einem BoardResponse-Objekt, das die Details des angeforderten
   *     Boards enthält.
   */
  @GetMapping("/{id}")
   ...
   * @return Eine ResponseEntity mit einem BoardResponse-Objekt, das die Details des neu erstellten
   *     Boards enthält.
   */
  @PostMapping
  ...
  /**
   * PUT /api/boards/{id} - Aktualisiert die Informationen eines bestehenden Boards basierend auf
   * den übergebenen Daten.
   *
   * @param id Die ID des Boards, das aktualisiert werden soll.
   * @param request Ein UpdateBoardRequest-Objekt, das die neuen Informationen für das Board
   *     enthält.
   * @return Eine ResponseEntity mit einem BoardResponse-Objekt, das die Details des aktualisierten
   *     Boards enthält.
   */
  @PutMapping("/{id}")
  ...
  /**
   * POST /api/boards/{id}/invite - Lädt einen Benutzer ein, an einem bestehenden Board
   * teilzunehmen, basierend auf den übergebenen Daten.
   *
   ...
   * @return Eine ResponseEntity mit einem BoardResponse-Objekt, das die Details des Boards enthält,
   *     zu dem der Benutzer eingeladen wurde.
   */
  @PostMapping("/{id}/invite")
  public ResponseEntity<BoardResponse> invite(
      @PathVariable Long id, @Valid @RequestBody InviteBoardRequest request) {
  ...
  /**
   * POST /api/boards/{id}/columns - Fügt eine neue Spalte zu einem bestehenden Board hinzu,
   * basierend auf den übergebenen Daten.
   *
   * @param id Die ID des Boards, zu dem die neue Spalte hinzugefügt werden soll.
   * @param request Ein UpdateBoardColumnRequest-Objekt, das die Informationen für die zu
   *     erstellende Spalte enthält.
   * @return Eine ResponseEntity mit einem BoardColumnResponse-Objekt, das die Details der neu
   *     erstellten Spalte enthält.
   */
  ...
  /**
   * PUT /api/boards/columns/{id} - Aktualisiert die Informationen einer bestehenden Spalte
   * basierend auf den übergebenen Daten.
   *
   * @param id Die ID der Spalte, die aktualisiert werden soll.
   * @param request Ein UpdateBoardColumnRequest-Objekt, das die neuen Informationen für die Spalte
   *     enthält.
   * @return Eine ResponseEntity mit einem BoardResponse-Objekt, das die Details des Boards enthält,
   *     zu dem die aktualisierte Spalte gehört.
   */
  ...
  /**
   * PUT /api/boards/columns/{id}/move - Verschiebt eine bestehende Spalte an eine neue Position
   * innerhalb des Boards basierend auf den übergebenen Parametern.
   *
   * @param columnId Die ID der Spalte, die verschoben werden soll.
   * @param position Die neue Position der Spalte innerhalb des Boards, basierend auf einem
   *     0-basierten Index.
   * @return Eine ResponseEntity mit einem leeren Body, die den Erfolg der Verschiebungsoperation
   *     anzeigt.
   */
  ...
  /**
   * DELETE /api/boards/columns/{id} - Löscht eine bestehende Spalte basierend auf der übergebenen
   * ID.
   *
  ...
  /**
   * POST /api/boards/columns/{columnId}/tasks - Fügt eine neue Aufgabe zu einer bestehenden Spalte
   * hinzu, basierend auf den übergebenen Daten.
   *
   * @param columnId Die ID der Spalte, zu der die neue Aufgabe hinzugefügt werden soll.
   * @param request Ein UpdateTaskRequest-Objekt, das die Informationen für die zu erstellende
   *     Aufgabe enthält.
   * @return Eine ResponseEntity mit einem TaskResponse-Objekt, das die Details der neu erstellten
   *     Aufgabe enthält.
   */
  @PostMapping("/columns/{columnId}/tasks")
  public ResponseEntity<TaskResponse> addTask(
      @PathVariable Long columnId, @Valid @RequestBody UpdateTaskRequest request) {
  ...
  /**
   * PUT /api/boards/tasks/{taskId} - Aktualisiert die Informationen einer bestehenden Aufgabe
   * basierend auf den übergebenen Daten.
   *
   * @param taskId Die ID der Aufgabe, die aktualisiert werden soll.
   * @param request Ein UpdateTaskRequest-Objekt, das die neuen Informationen für die Aufgabe
   *     enthält.
   * @return Eine ResponseEntity mit einem TaskResponse-Objekt, das die Details der aktualisierten
   *     Aufgabe enthält.
   */
  ...
  /**
   * PUT /api/boards/tasks/{taskId}/move - Verschiebt eine bestehende Aufgabe an eine neue Position
   * innerhalb einer Spalte oder zwischen Spalten basierend auf den übergebenen Parametern.
   *
   ...
   * @param position Die neue Position der Aufgabe innerhalb der Zielspalte, basierend auf einem
   *     0-basierten Index.
   * @return Eine ResponseEntity mit einem TaskResponse-Objekt, das die Details der verschobenen
   *     Aufgabe enthält.
   */
  ...
  /**
   * DELETE /api/boards/tasks/{taskId} - Löscht eine bestehende Aufgabe basierend auf der
   * übergebenen ID.
   *
