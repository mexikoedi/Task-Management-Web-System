 ...
 * Sie kommuniziert mit einem Backend-API, um Daten zu erstellen, abzurufen, zu aktualisieren und zu löschen.
...
export class BoardService {
   ...
   * Diese Methode sendet eine GET-Anfrage an das Backend-API und gibt ein Observable zurück,
   ...
   * Diese Methode sendet eine GET-Anfrage an das Backend-API mit der Board-ID in der URL und gibt ein Observable zurück,
   ...
   * Diese Methode sendet eine POST-Anfrage an das Backend-API mit den Board-Daten im Request-Body.
   *
   ...
   * Diese Methode sendet eine PUT-Anfrage an das Backend-API mit der Board-ID in der URL und den aktualisierten
   ...
   * Diese Methode sendet eine DELETE-Anfrage an das Backend-API mit der Board-ID in der URL und der E-Mail-Adresse
   ...
   * Diese Methode sendet eine POST-Anfrage an das Backend-API mit der Board-ID in der URL und dem Spaltentitel im
   * Request-Body.
   *
   ...
   * Diese Methode sendet eine PUT-Anfrage an das Backend-API mit der Spalten-ID in der URL und den aktualisierten
   ...
   * Diese Methode sendet eine PUT-Anfrage an das Backend-API mit der Spalten-ID in der URL und der neuen Position
   * als Query-Parameter.
   *
   ...
   * Diese Methode sendet eine DELETE-Anfrage an das Backend-API mit der Spalten-ID in der URL.
   *
   ...
   * Diese Methode sendet eine POST-Anfrage an das Backend-API mit der Spalten-ID in der URL und den Aufgabendaten
   * im Request-Body.
   *
   ...
   * Diese Methode sendet eine PUT-Anfrage an das Backend-API mit der Aufgaben-ID in der URL und den aktualisierten
   ...
   * Diese Methode sendet eine PUT-Anfrage an das Backend-API mit der Aufgaben-ID in der URL und den Ziel-Spalten-ID
   ...
   * Diese Methode sendet eine DELETE-Anfrage an das Backend-API mit der Aufgaben-ID in der URL.
   *
